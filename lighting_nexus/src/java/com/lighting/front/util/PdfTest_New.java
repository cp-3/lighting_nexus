...
public class PdfTest_New {
	protected static Log logger = LogFactory.getLog(PdfTest_New.class);
	// 表头
	...
	public static void buildPdf() {
		...
		try {
			// 使用PDFWriter进行写文件操作
			PdfWriter.getInstance(document, new FileOutputStream("E:\\lighting.pdf"));
			document.open();
			// 中文字体
			...
			Image jpeg1 = Image.getInstance("E:\\l_1.jpg");jpeg1.scalePercent(50);jpeg1.setAlignment(Image.LEFT);
			Image jpeg2 = Image.getInstance("E:\\l_2.jpg");jpeg2.scalePercent(50);jpeg2.setAlignment(Image.LEFT);
			Image jpeg3 = Image.getInstance("E:\\l_3.jpg");jpeg3.scalePercent(50);jpeg3.setAlignment(Image.LEFT);
