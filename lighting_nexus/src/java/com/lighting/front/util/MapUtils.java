...
//    		System.out.println(entry.getKey()+": "+entry.getValue());    
	 ...
	 * 存储灯安装类型
	 */
	private static Map<String, String> installTypeMap = new HashMap<String, String>();
	static {
		installTypeMap.put("1", "轨道式灯");
		installTypeMap.put("2", "埋入式灯");
		installTypeMap.put("3", "明装式灯");
		installTypeMap.put("4", "吊装式灯");
		installTypeMap.put("5", "明装壁灯");
		installTypeMap.put("6", "埋入式壁灯");
		installTypeMap.put("7", "地埋式灯");
		installTypeMap.put("8", "其他");
	}
	public static String getInstallType(String status) {
		System.out.println(status);
		if (status == null || "".equals(status)) {
			return "其他";
		} else {
			return installTypeMap.get(status);
		}
	}
	 ...
	 * 存储灯功能类型
	 */
	private static Map<String, String> functionTypeMap = new HashMap<String, String>();
	static {
		functionTypeMap.put("1", "圆形光斑");
		functionTypeMap.put("2", "圆形光斑可调角度");
		functionTypeMap.put("3", "椭圆光斑");
		functionTypeMap.put("4", "洗墙灯");
		functionTypeMap.put("5", "投影灯");
		functionTypeMap.put("6", "掠射光");
		functionTypeMap.put("7", "上出光");
		functionTypeMap.put("8", "下出光");
		functionTypeMap.put("9", "上下出光");
		functionTypeMap.put("10", "侧出光");
		functionTypeMap.put("11", "其他");
	}
	public static String getfunctionType(String status) {
		System.out.println(status);
		if (status == null || "".equals(status)) {
			return "其他";
		} else {
			return functionTypeMap.get(status);
		}
	}
	 ...
	 * 存储灯功能类型
	 */
	private static Map<String, String> lightSouTypeMap = new HashMap<String, String>();
	static {
		lightSouTypeMap.put("1", "LED");
		lightSouTypeMap.put("2", "卤素灯");
		lightSouTypeMap.put("3", "金卤灯");
		lightSouTypeMap.put("4", "紧凑型荧光灯");
		lightSouTypeMap.put("5", "直管荧光灯");
		lightSouTypeMap.put("6", "其他");
	}
	public static String getlightSouType(String status) {
		System.out.println(status);
		if (status == null || "".equals(status)) {
			return "其他";
		} else {
			return lightSouTypeMap.get(status);
		}
	}
}
