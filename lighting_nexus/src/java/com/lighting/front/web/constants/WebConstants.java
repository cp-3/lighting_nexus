...
public interface WebConstants {
    ...
    /**app名称*/
    public static final String APP_NAME = "Lighting Nexus";
    ...
    public static final String lighting_ENV_SWITCH_TEST = "TEST";
    /**PRD--生产环境*/
    public static final String lighting_ENV_SWITCH_PRD = "PRD";
    /**
     * 子账户类型 --- 产品类 P
     */
